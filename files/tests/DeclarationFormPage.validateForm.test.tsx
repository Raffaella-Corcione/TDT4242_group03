...
// Ensure useNavigate is mocked to avoid navigation errors during the test
...
describe('DeclarationFormPage validateForm happy path', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it('accepts valid inputs and proceeds with submission (validateForm returns true behavior)', async () => {
    render(
      <MemoryRouter>
        <DeclarationFormPage />
      </MemoryRouter>
    ...
    // Fill in form fields with the specified test data
    ...
    // Also assert that no validation error was rendered
